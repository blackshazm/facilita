...
import { Zap, Mail, Lock, User, Loader2, ArrowRight, ShieldCheck } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted/20 px-4 py-20">
      <Link href="/" className="absolute top-8 left-8 flex items-center gap-2">
        ...
        <span className="text-xl font-bold tracking-tight">Chama<span className="text-primary">Ai</span></span>
      </Link>

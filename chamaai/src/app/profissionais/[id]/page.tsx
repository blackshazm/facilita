          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-muted/30 rounded-3xl p-6 space-y-4 border border-white">
                <h3 className="font-bold text-sm">Garantias ChamaAi</h3>
            ...
            <div className="lg:col-span-2 space-y-12 h-fit">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  {provider.bio || "Este profissional ainda não adicionou uma biografia detalhada. No entanto, ele é um parceiro verificado pela ChamaAi e está pronto para atender suas necessidades elétricas."}
                </p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-8 rounded-3xl bg-muted/10 border-2 border-dashed border-muted text-center space-y-2">
                    <p className="text-muted-foreground font-medium">As avaliações de clientes via ChamaAi aparecerão aqui após a conclusão dos jobs.</p>
                  </div>
                </div>
              </div>
            </div>
